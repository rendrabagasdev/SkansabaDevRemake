...
class StoreKaryaSiswaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'kategori' => ['required', 'string', 'max:255'], // web, mobile, desktop, game, etc
            'teknologi' => ['required', 'string', 'max:255'], // tech stack
