<div class="min-h-screen bg-gray-50">
    ...
    <section class="bg-white py-8 border-b">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <p class="text-gray-600 text-lg">Pencapaian dan prestasi terbaik siswa Rekayasa Perangkat Lunak</p>
        </div>
    </section>
            ...
            @if($prestasis->count() > 0)
                <div class="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
                    @foreach($prestasis as $prestasi)
                        <a href="/prestasi/{{ $prestasi->id }}" class="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition group">
                            @if($prestasi->gambar)
