<div class="min-h-screen bg-gray-50">
    ...
    <section class="bg-white py-8 border-b">
        <div class="max-w-7xl mx-auto px-6">
            ...
            {{-- Back Button --}}
            <a href="/struktur-organisasi" class="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-4">
                ...
                <div class="mt-12">
                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        @foreach($relatedMembers as $related)
                            <a href="/struktur-organisasi/{{ $related->id }}" class="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition group">
                                @if($related->foto_url)
