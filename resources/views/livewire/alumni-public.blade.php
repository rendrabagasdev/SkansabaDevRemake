<div class="min-h-screen bg-gray-50">
    ...
    <section class="bg-white py-8 border-b">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <p class="text-gray-600 text-lg">Alumni Jurusan Rekayasa Perangkat Lunak yang telah berkarir di berbagai bidang</p>
        </div>
    </section>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            @foreach($alumnis as $alumni)
                                <a href="/alumni/{{ $alumni->id }}" class="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition group block">
                                    @if($alumni->foto_url)
